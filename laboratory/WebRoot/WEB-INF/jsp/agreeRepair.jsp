	...
	<div class="panel panel-default">
			<div class="panel-body">
				<form class="form-inline" method="get" 
				      action="${pageContext.request.contextPath }/product/queryAgreeRepair.action">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="font-size: 20px;font-weight: bold;">已批报修器材信息列表</div>
					<!-- /.panel-heading -->
					<table class="table table-bordered table-striped">
					  <form id="agreeRepair">
						<thead>
								...
								<%  
									Page<product> p = (Page<product>) request.getAttribute("page2");
								...
								<td>
									<%
										SimpleDateFormat sdf1 = new SimpleDateFormat("yyyy-MM-dd");
											out.print(sdf1.format(row.getRecordDate()));
									%>
								</td>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">创建报修器材信息信息</h4>
			</div>
			<div class="modal-body">
...
//清空新建客户窗口中的数据
	...
	function editCustomer(id) {
	    $.ajax({
	        type:"get",
	        url:"<%=basePath%>product/getCustomerById.action",
	        data:{"id":id},
	...
	function(data){
	            if(data =="OK"){
	                alert("客户删除成功！");
	                window.location.reload();//再返回到本页面
	            }else{
	                alert("删除客户失败！");
	                window.location.reload();
	            }
